  ...
  return (
    <div className="h-screen bg-gray-200 p-10">
      <div className="bg-gray-50 p-5 flex flex-col gap-4 rounded-md relative">
        <div className="absolute right-10 flex flex-col gap-4 items-center">
          <div className="">
        ...
        <div className="flex w-96  justify-between  items-center my-2">
          <span className="text-semibold text-lg">Field :</span>
          <input
        ...
        <div className="flex flex-col items-center    justify-center ">
          <div>
            <button onClick={() => navigate('/') } className="pointer-cursor bg-blue-400 px-2 py-1 rounded-md ">
              SUBMIT
            </button>
          </div>
          <a href="/studentprofile" className="underline text-blue-400">
            Are you a student ?
          </a>
        </div>
      </div>
